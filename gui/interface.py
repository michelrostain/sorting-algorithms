...
# Racine du projet = dossier parent de gui/
...
_spec = _ilu.spec_from_file_location(
    "sorting",
    os.path.join(RACINE, "tris", "sorting.py")
)
_sorting = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_sorting)

tri_selection = _sorting.tri_selection
tri_insertion = _sorting.tri_insertion
bubble_sort   = _sorting.bubble_sort
quick_sort    = _sorting.quick_sort
tri_fusion    = _sorting.tri_fusion
tri_tas       = _sorting.tri_tas
tri_peigne    = _sorting.tri_peigne
...
class AppTri(tk.Tk):
    ...
    def _lancer_tri(self):
        ...
        self._thread = threading.Thread(
            target=self._executer_tri, args=(algo_nom, cfg), daemon=True)
        self._thread.start()
